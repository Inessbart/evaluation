 ...
 */
final class Version20210826084229 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produits ADD categorie_id INT NOT NULL, ADD panier_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produits DROP categorie_id, DROP panier_id');
    }
}
